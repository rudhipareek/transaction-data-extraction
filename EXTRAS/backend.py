...
# Define a function to convert image bytes to an OpenCV image
...
def process_image(image_bytes):
    try:
        ...
        image_cv = bytes_to_cv_image(image_bytes)
...
# Define a function to retrieve all transaction records from the database
...
# Define a function to close the database connection when done
